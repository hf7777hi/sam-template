1. mkdir sam-template/[projectName]
2. template.yaml Resourcesに記載
3. sam-template/[projectName]/app.py にhandler定義。
4. sam-template/[projectName]/ に実装

※template.yamlにマルチバイト文字は書いてはいけない。


# sam-template

This is a sample template for sam-template - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-template --tail
```
